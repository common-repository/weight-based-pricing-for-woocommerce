    ...
    public static function simpleProduct($product, $product_data)
    {
        ...
        ?>
            <div class="wwbp_calculation_section">
                ...
                <table>
                    <tr>
                        <td><?php echo esc_html($weight_label . " (" . $weight_unit) . ")"; ?></td>
                        <td>
                            <span class="weight">
                                ...
                                <input 
                                    ...
                                    max="<?php echo esc_html($max_qty); ?>"
                                    min="<?php echo esc_html($min_qty); ?>"
                                    step="<?php echo esc_html($interval); ?>"
                                    value="<?php echo esc_html($min_qty); ?>"
                                    autofocus required <?php if (!$custom_input_is_enable) echo "readonly"; ?>>
                    ...
                    <tr>
                        <td><b><?php echo esc_html($sale_price_label); ?></b></td>
                        <td>
