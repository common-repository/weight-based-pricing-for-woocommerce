    ...
    public static function addNewRowForSimpleProduct($post_id, $product_data = '', $row_unique_id = '')
    {
        ...
        if (isset($product_data['wwbp_pricing_rule'][0])) 
        {
            ...
            if (is_array($measure_ranges) && !empty($measure_ranges)) 
            {
                ...
                $from_range = isset($range_datas['wwbp_from_weight']) ? $range_datas['wwbp_from_weight'] : '';
                $to_range = isset($range_datas['wwbp_to_weight']) ? $range_datas['wwbp_to_weight'] : '';
                $unit_price = isset($range_datas['wwbp_unit_price']) ? $range_datas['wwbp_unit_price'] : '';
                $sale_price = isset($range_datas['wwbp_sale_price']) ? $range_datas['wwbp_sale_price'] : '';
